...
func autoConvert_config_KubeletConfiguration_To_v1beta1_KubeletConfiguration(in *config.KubeletConfiguration, out *v1beta1.KubeletConfiguration, s conversion.Scope) error {
	...
	// WARNING: in.CPUHCBSSched requires manual conversion: does not exist in peer-type
	// WARNING: in.CPURTRuntime requires manual conversion: does not exist in peer-type
	// WARNING: in.CPURTPeriod requires manual conversion: does not exist in peer-type
	out.MaxOpenFiles = in.MaxOpenFiles
	out.ContentType = in.ContentType
