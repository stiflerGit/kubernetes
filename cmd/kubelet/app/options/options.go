...
func AddKubeletConfigFlags(mainfs *pflag.FlagSet, c *kubeletconfig.KubeletConfiguration) {
	...
	fs.BoolVar(&c.RTHCBSSched, "rt-hcbs-scheduler", c.RTHCBSSched, "Enables realtime HCBS scheduling of containers")
	fs.DurationVar(&c.RTPeriod.Duration, "rt-runtime", c.RTPeriod.Duration, "Sets the the CPU runtime value, cpu.rt_runtime_us")
