...
func AddKubeletConfigFlags(mainfs *pflag.FlagSet, c *kubeletconfig.KubeletConfiguration) {
	...
	fs.BoolVar(&c.CPUHCBSSched, "rt-hcbs-scheduler", c.CPUHCBSSched, "Enables realtime HCBS scheduling of containers")
	fs.DurationVar(&c.CPURTPeriod.Duration, "rt-runtime", c.CPURTPeriod.Duration, "Sets the the CPU runtime value, cpu.rt_runtime_us")
	fs.DurationVar(&c.CPURTPeriod.Duration, "rt-period", c.CPURTPeriod.Duration, "Sets the the CPU period value, cpu.rt_perios_us")
